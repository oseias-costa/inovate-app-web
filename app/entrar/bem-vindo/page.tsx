        ...
        <section style={styles.body}>
            <div style={styles.constainer}>
                <div style={Object.assign(styles.topContent)}>
                    ...
                    <div>
                        <Title level={3} style={{textAlign: 'left', color: '#404040'}}>Bem vindo!</Title>
                        <Typography style={{position: 'relative', bottom: 10, color: '#8c8c8c'}}>
                            Clique abaixo na opção desejada para continuar a autenticação
                        </Typography>
                    </div>
                </div>
                <Button type="primary" style={{marginBottom: 5}} onClick={() => router.push('/entrar/selecione')}>Entrar</Button>
